...
if (isset($_SESSION['passAdd']))
    {
    unset($_SESSION['passAdd']);
    echo "<script>swal('Wprowadzono usługę','', 'success');</script>";
    }
...
if (isset($_POST['name'])) {
    ...
    if ($val_pass == true && isset($_POST['add'])) {
        ...
        $newCard->addCard($id_card, $id_customer, $id_service, $valid_from, $valid_to);
                        ...
                        <div class="userRegistry_border">
                            ...
                            <form action="#" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-6">
                                        <input class="form-control" type="text" placeholder="ID karty" name="id_card" required id="id_card" value="<?php
